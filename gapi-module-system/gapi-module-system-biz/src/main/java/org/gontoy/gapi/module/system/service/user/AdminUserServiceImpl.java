...
import org.gontoy.gapi.framework.datapermission.core.util.DataPermissionUtils;
...
import org.gontoy.gapi.module.system.convert.user.UserConvert;
...
public class AdminUserServiceImpl implements AdminUserService {
    ...
    @Value("${sys.user.init-password:gapiyuanma}")
