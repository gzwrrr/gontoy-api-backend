package org.gontoy.gapi.framework.websocket.core;
...
public class GapiWebSocketHandlerDecorator extends WebSocketHandlerDecorator {
    public GapiWebSocketHandlerDecorator(WebSocketHandler delegate) {
        super(delegate);
    }
