package org.gontoy.gapi.module.infra.service.codegen.inner;
...
import org.gontoy.gapi.framework.excel.core.annotations.DictFormat;
import org.gontoy.gapi.framework.excel.core.convert.DictConvert;
import org.gontoy.gapi.framework.excel.core.util.ExcelUtils;
import org.gontoy.gapi.framework.mybatis.core.dataobject.BaseDO;
...
import org.gontoy.gapi.framework.operatelog.core.enums.OperateTypeEnum;
...
import org.gontoy.gapi.module.infra.enums.codegen.CodegenSceneEnum;
import org.gontoy.gapi.module.infra.framework.codegen.config.CodegenProperties;
...
public class CodegenEngine {
    ...
    private static String javaModuleFilePath(String path, String module, String src) {
        return "gapi-module-${table.moduleName}/" + // 顶级模块
                "gapi-module-${table.moduleName}-" + module + "/" + // 子模块
                "src/" + src + "/java/${basePackage}/module/${table.moduleName}/" + path + ".java";
    }

    private static String mapperXmlFilePath() {
        return "gapi-module-${table.moduleName}/" + // 顶级模块
                "gapi-module-${table.moduleName}-biz/" + // 子模块
    ...
    private static String vueFilePath(String path) {
        return "gapi-ui-${sceneEnum.basePackage}/" + // 顶级目录
                "src/" + path;
    }
    ...
    private static String vue3FilePath(String path) {
        return "gapi-ui-${sceneEnum.basePackage}-vue3/" + // 顶级目录
                "src/" + path;
    }
}
