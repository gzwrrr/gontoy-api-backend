...
public class ProjectReactor {
    ...
    private static final String GROUP_ID = "org.gontoy";
    private static final String ARTIFACT_ID = "gapi";
    private static final String PACKAGE_NAME = "org.gontoy.gapi";
    private static final String TITLE = "GAPI 动态网关管理系统";
    ...
    public static void main(String[] args) {
        ...
        // ========== 配置，需要你手动修改 ==========
        String groupIdNew = "org.gontoy";
        String artifactIdNew = "gapi";
        String packageNameNew = "org.gontoy.gapi";
        String titleNew = "GAPI 动态网关管理系统";
