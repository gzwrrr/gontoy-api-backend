package org.gontoy.gapi.module.system.service.user;

import cn.hutool.core.util.RandomUtil;
import org.gontoy.gapi.framework.common.enums.CommonStatusEnum;
import org.gontoy.gapi.framework.common.exception.ServiceException;
import org.gontoy.gapi.framework.common.pojo.PageResult;
import org.gontoy.gapi.framework.common.util.collection.ArrayUtils;
import org.gontoy.gapi.framework.common.util.collection.CollectionUtils;
import org.gontoy.gapi.framework.test.core.ut.BaseDbUnitTest;
import org.gontoy.gapi.module.infra.api.file.FileApi;
import org.gontoy.gapi.module.system.controller.admin.user.vo.profile.UserProfileUpdatePasswordReqVO;
import org.gontoy.gapi.module.system.controller.admin.user.vo.profile.UserProfileUpdateReqVO;
import org.gontoy.gapi.module.system.controller.admin.user.vo.user.*;
import org.gontoy.gapi.module.system.dal.dataobject.dept.DeptDO;
import org.gontoy.gapi.module.system.dal.dataobject.dept.PostDO;
import org.gontoy.gapi.module.system.dal.dataobject.dept.UserPostDO;
...
import org.gontoy.gapi.module.system.dal.mysql.dept.UserPostMapper;
import org.gontoy.gapi.module.system.dal.mysql.user.AdminUserMapper;
import org.gontoy.gapi.module.system.enums.common.SexEnum;
import org.gontoy.gapi.module.system.service.dept.DeptService;
import org.gontoy.gapi.module.system.service.dept.PostService;
import org.gontoy.gapi.module.system.service.permission.PermissionService;
import org.gontoy.gapi.module.system.service.tenant.TenantService;
...
import static org.gontoy.gapi.framework.common.util.collection.SetUtils.asSet;
import static org.gontoy.gapi.framework.common.util.date.LocalDateTimeUtils.buildBetweenTime;
import static org.gontoy.gapi.framework.common.util.date.LocalDateTimeUtils.buildTime;
import static org.gontoy.gapi.framework.common.util.object.ObjectUtils.cloneIgnoreId;
import static org.gontoy.gapi.framework.test.core.util.AssertUtils.assertPojoEquals;
import static org.gontoy.gapi.framework.test.core.util.AssertUtils.assertServiceException;
import static org.gontoy.gapi.framework.test.core.util.RandomUtils.*;
import static org.gontoy.gapi.module.system.enums.ErrorCodeConstants.*;
...
public class AdminUserServiceImplTest extends BaseDbUnitTest {
    ...
    public void testCreatUser_success() {
        ...
        when(passwordEncoder.encode(eq(reqVO.getPassword()))).thenReturn("gapiyuanma");
        ...
        assertEquals("gapiyuanma", user.getPassword());
    ...
    public void testImportUserList_02() {
        ...
        when(deptService.getDept(eq(dept.getId()))).thenReturn(dept);
        // mock passwordEncoder 的方法
        when(passwordEncoder.encode(eq("gapiyuanma"))).thenReturn("java");
