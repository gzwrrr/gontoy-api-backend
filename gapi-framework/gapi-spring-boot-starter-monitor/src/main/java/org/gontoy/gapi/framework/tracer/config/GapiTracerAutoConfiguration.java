...
import org.gontoy.gapi.framework.tracer.core.aop.BizTraceAspect;
import org.gontoy.gapi.framework.tracer.core.filter.TraceFilter;
...
@ConditionalOnProperty(prefix = "gapi.tracer", value = "enable", matchIfMissing = true)
public class GapiTracerAutoConfiguration {
