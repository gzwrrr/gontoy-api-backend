...
import org.gontoy.gapi.module.infra.controller.admin.logger.vo.apierrorlog.ApiErrorLogExportReqVO;
import org.gontoy.gapi.module.infra.controller.admin.logger.vo.apierrorlog.ApiErrorLogPageReqVO;
import org.gontoy.gapi.module.infra.dal.dataobject.logger.ApiErrorLogDO;
import org.gontoy.gapi.module.infra.dal.mysql.logger.ApiErrorLogMapper;
import org.gontoy.gapi.module.infra.enums.logger.ApiErrorLogProcessStatusEnum;
...
import static org.gontoy.gapi.module.infra.enums.ErrorCodeConstants.API_ERROR_LOG_NOT_FOUND;
import static org.gontoy.gapi.module.infra.enums.ErrorCodeConstants.API_ERROR_LOG_PROCESSED;
...
public class ApiErrorLogServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetApiErrorLogPage() {
        ...
        ApiErrorLogDO apiErrorLogDO = randomPojo(ApiErrorLogDO.class, o -> {
            ...
            o.setApplicationName("gapi-test");
            o.setRequestUrl("foo");
        ...
        reqVO.setApplicationName("gapi-test");
